...
if(isTRUE(check_load)) {
  ...
  dt_all_raw[['ME01_gme_xbid_offers']] = dt_xbid_offers[bid_offer_date_dt_parsed > from_data]
  new_data_tables = rbind(new_data_tables, data.table::data.table(
...
# from_data <- as.Date('2025-06-01')
# Get filename list -----------------------------------
mia1_offers_files = gme_offers_get_files(data_type = 'MI-A1', output_dir = output_dir, username = username, password = password)
...
saveRDS(dt_mia1_offers, file = "dt_mia1_offers.rds")
dt_mia1_offers <- as.data.table(readRDS("dt_mia1_offers.rds"))
...
if(isTRUE(check_load)) {
  ...
  dt_all_raw[['ME01_gme_mia1_offers']] = dt_mia1_offers[bid_offer_date_dt_parsed > from_data]
  new_data_tables = rbind(new_data_tables, data.table::data.table(
...
if(isTRUE(check_load)) {
  ...
  dt_all_raw[['ME01_gme_mia2_offers']] = dt_mia2_offers[bid_offer_date_dt_parsed > from_data]
  new_data_tables = rbind(new_data_tables, data.table::data.table(
...
if(isTRUE(check_load)) {
  ...
  dt_all_raw[['ME01_gme_mia3_offers']] = dt_mia3_offers[bid_offer_date_dt_parsed > from_data]
  new_data_tables = rbind(new_data_tables, data.table::data.table(
